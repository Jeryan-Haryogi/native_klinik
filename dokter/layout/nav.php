   <nav class="topnav navbar navbar-expand shadow navbar-light bg-white" id="sidenavAccordion">
            <a class="navbar-brand d-none d-sm-block" href="index.html">SB Admin Pro</a><button class="btn btn-icon btn-transparent-dark order-1 order-lg-0 mr-lg-2" id="sidebarToggle" href="#"><i data-feather="menu"></i></button>
                ...
                <li class="nav-item dropdown no-caret mr-3 dropdown-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right border-0 shadow animated--fade-in-up" aria-labelledby="navbarDropdownUserImage">
                        ...
                        ><a class="dropdown-item" href="keluar.php"
                            ><div class="dropdown-item-icon"><i data-feather="keluar.php"></i></div>
                            Logout</a
                        >
                    </div>
                </li>
