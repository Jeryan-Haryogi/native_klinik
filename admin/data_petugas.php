...
<nav aria-label="breadcrumb">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a href="edit_petugas.php?id=<?= $d['id'] ?>" class="btn btn-primary "><i class="fas fa-edit"></i></a>
        <a href="hapus_petugas.php?id=<?= $d['id'] ?>" onClick="confirm('Yakin Anda Hapus??')" class="btn btn-danger "><i class="fas fa-trash"></i></a>
      </td>
    </tr>
  <?php endwhile; ?>
  </tbody>
