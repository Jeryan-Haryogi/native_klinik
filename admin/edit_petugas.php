...
if (isset($_POST['submit'])) {
    ...
    $bulan = $_POST['bulan'];
    $tahun = $_POST['tahun'];
    $sql2 = "UPDATE petugas SET nama = '$nama', tgl_lahir = '$tgl', no_tlp = '$notlp', akses = '$akses', agama = '$agama', password = '$password', bulan = '$bulan', tahun = '$tahun'";
  ...
  <div class="card shadow mb-4">
                ...
                value="<?= $d['nama'] ?>">
                		  	...
                		  	<div class="col-md-6">
                                <label>Email</label>
                		  		<div class="form-group">
						    <input type="email" class="form-control" placeholder="Masukan Email " width="20%"  style="border-radius: 20px;" value="<?= $d['email'] ?>" name="email
                ">
						  </div>
